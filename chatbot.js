...
(function() {
    const bgmBotData = {
        ...
        ar: { msg: "مرحبًا بك في BridgeMindGames. كيف puedeنا مساعدتك؟", btn: "الدعم عبر تلغرام", link: "https://t.me/TuUsuario", extra: "Email" },
    ...
    // Usamos el nombre que tu botón busca: toggleChatbot
    window.toggleChatbot = function() {
        ...
        if (container.style.display === 'none' || container.style.display === '') {
            ...
            // AQUÍ ESTÁ EL CAMBIO:
            // En lugar de una variable inexistente, leemos el idioma directamente de tu página
            const currentLang = document.documentElement.lang || 'es';
            const t = bgmBotData[currentLang] || bgmBotData['es'];
